...
require 'study_controller'

# Re-raise errors caught by the controller.
class StudyController; def rescue_action(e) raise e end; end

class StudyControllerTest < Test::Unit::TestCase
  fixtures :experiments

  def setup
    @controller = StudyController.new
