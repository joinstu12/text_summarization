...
#        del temp
    ...
    ROUGE_path = '~/nlp3/nlp2/PythonROUGE/RELEASE-1.5.5/ROUGE-1.5.5.pl'
    data_path = '~/nlp3/nlp2/PythonROUGE/RELEASE-1.5.5/data'
...
def create_xml(xml_file,guess_summ_file,ref_summ_list):
    ...
    letter_list = ['A','B','C','D','E','F','G','H','I','J','K','L','M','N','O','P','R','S','T','U','V','W','X','Y','Z','AA','BB','CC','DD','EE','FF','GG','HH','II']
